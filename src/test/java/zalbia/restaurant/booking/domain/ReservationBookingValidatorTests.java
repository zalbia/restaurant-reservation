...
public class ReservationBookingValidatorTests {

    private static ReservationBookingValidator reservationFactory;
    ...
    public static void beforeAll() {
        ...
        reservationFactory = new ReservationBookingValidator(validator);
    }
    ...
    public void acceptsValidReservation() {
        assertDoesNotThrow(() ->
                reservationFactory.validateBooking(
                        new ReservationBooking(
                                1L,
                                "Customer",
                                "+639160000000",
